...
| `workscope-identity` | WorkScope identity, evidence-first resolution order, authenticated proposals, ScopeBindingGuard revalidation, and scope transition. | `crates/governor/eliot-workscope/**`<br>`crates/governor/eliot-governor/**` | `workscope`<br>`scope identity`<br>`resolution order`<br>`scope binding guard`<br>`scope candidate`<br>`bootstrap scanner`<br>`scope transition`<br>`scope resolution receipt` | `I4`<br>`I4.1`<br>`I4.2`<br>`I4.2.1`<br>`I4.3`<br>`I4.3.1`<br>`I4.7` | `I4.4`<br>`I4.4.1`<br>`I4.5`<br>`I4.6`<br>`I4.8`<br>`I4.*` |
