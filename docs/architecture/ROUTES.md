...
| `instrument-verification` | Instrument Plane, test execution, evidence envelopes, code understanding, proof breadth, and completion evidence. | `bins/eliot-testd/**`<br>`scripts/audit-*.py`<br>`scripts/verify-*.py`<br>`tests/**`<br>`crates/**/*instrument*/**`<br>`crates/**/*verification*/**`<br>`crates/eliot-engine/src/eval*`<br>`crates/eliot-types/src/eval*` | `instrument`<br>`verification`<br>`verifier`<br>`evidence envelope`<br>`proof`<br>`test harness`<br>`code cortex`<br>`evaluation integrity`<br>`eval receipt`<br>`measurement honesty`<br>`evaluator benchmark` | `A5.5`<br>`A10.8`<br>`A14.6..A14.8`<br>`I2.17`<br>`I2.20..I2.23`<br>`I10.8..I10.10`<br>`I16.17`<br>`I17`<br>`I18`<br>`I18.43`<br>`I18.47`<br>`APPENDIX-J`<br>`APPENDIX-P` | `I10.*`<br>`I17.*`<br>`I18.*` |
...
| `memory-admission-trace` | Memory admission decisions, retrieval plans, and per-material retrieval trace linkage (I12.26). | `crates/smart/eliot-context-admission/**`<br>`crates/smart/eliot-reactive-context-plan/src/retrieval_plan.rs`<br>`crates/smart/eliot-reactive-context-plan/src/compiler.rs`<br>`crates/governor/eliot-governor/src/reactive_admission.rs` | `memory admission`<br>`retrieval plan`<br>`retrieval trace`<br>`recall disposition` | `I12.26` | `I12.*`<br>`I13` |
| `improvement-learning` | Improvement candidate intake, bounds, and learning closure, plus the exact maintenance pipeline and daemon candidate route that consume them (I12.24). | `crates/meta/eliot-improvement/**`<br>`crates/governor/eliot-maintenance/src/improvement_pipeline.rs`<br>`bins/eliotd/src/improvement_candidate_route.rs` | — | `I12.24` | `I12.*`<br>`I13` |
...
| `workspace-governance` | Workspace build graph, repository policy, tests, scripts, active workstreams, and configuration changes. | `Cargo.toml`<br>`Cargo.lock`<br>`**/Cargo.toml`<br>`rust-toolchain.toml`<br>`deny.toml`<br>`.typos.toml`<br>`Justfile`<br>`tool-versions.json`<br>`mcpls.toml`<br>`.github/**`<br>`scripts/**`<br>`tests/**`<br>`config/**`<br>`workspace/**`<br>`workstreams/**`<br>`workers/**`<br>`T*.md` | `workspace`<br>`cargo`<br>`repository policy`<br>`workstream`<br>`build graph`<br>`configuration` | `A10.4`<br>`A14.8`<br>`I2.17`<br>`I2.20..I2.23`<br>`I17`<br>`I18` | `I2.*`<br>`I17.*`<br>`I18.*` |
| `repository-root` | Root-level repository identity, licensing, tool pins, and contributor entry surfaces. | `.gitattributes`<br>`.gitignore`<br>`LICENSE`<br>`README.md`<br>`WORKFLOW.md`<br>`START.md`<br>`.typos.toml`<br>`Cargo.toml`<br>`Cargo.lock`<br>`Justfile`<br>`deny.toml`<br>`mcpls.toml`<br>`rust-toolchain.toml`<br>`tool-versions.json` | `repository root`<br>`license`<br>`toolchain pin` | `A0.4`<br>`A14.8`<br>`I0.14`<br>`I2.17`<br>`I18` | `I20` |
