...
PR #26 is the sole active nonstandard branch. Merged PR #34 refreshed
`cognitive-micromodules-wave-01` from the final repository-cleanup `main`.
Mutation is permitted only inside the exact prototype-manifest/assignment scope
declared in `ACTIVE.toml`; the branch is not a place for unrelated fixes,
implementation, or general Dreamer development. It is retired when PR #26 is
