...
fn admission_receipt(
    ...
    Ok(ProviderAdmissionReceipt {
        ...
        coordinator_lease: serde_json::from_value::<WorkLeaseId>(serde_json::json!({"namespace": "eliot.governor.work-lease", "revision": "v1", "value": "coordinator-lease-normalization"}))?,
