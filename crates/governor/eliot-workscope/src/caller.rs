...
use eliot_contracts::{ResourceGeneration, StateFence, canonical_json_bytes, fences_match_exact, sha256_hex};
...
pub fn derive_observed_resources(
    ...
    let mut supporting_evidence = vec![IdentityEvidence {
        class: super::SupportingEvidenceClass::DisplayName,
    ...
    for manifest in &facts.manifest_names {
        supporting_evidence.push(IdentityEvidence {
            class: super::SupportingEvidenceClass::ManifestNameMatch,
    ...
    if let Some(remote) = &facts.remote_url {
        supporting_evidence.push(IdentityEvidence {
            class: super::SupportingEvidenceClass::RemoteUrl,
    ...
    if facts.eliot_marker_present {
        supporting_evidence.push(IdentityEvidence {
            class: super::SupportingEvidenceClass::CopiedMarker,
