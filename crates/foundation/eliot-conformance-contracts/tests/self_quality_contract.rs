...
use eliot_conformance_contracts::{
    ...
    SELF_QUALITY_CANDIDATE_SCHEMA, SELF_QUALITY_CONTRACT_VERSION, SELF_QUALITY_HANDOFF_SCHEMA,
    SELF_QUALITY_SCHEMA, SelfQualityContractError, SelfQualityDiagnosisCandidate,
    SelfQualityDimension, SelfQualityHandoff, SelfQualityHandoffOwner, SelfQualityInput,
    SelfQualityObservation, SelfQualityPolicy, Severity, SourceIdentity, SupportObservationState,
    UnknownDiagnosis, canonicalize_dimension_outcomes, canonicalize_handoffs,
    canonicalize_observations, canonicalize_self_quality_input, digest_candidate,
    digest_self_quality_input, digest_self_quality_policy, validate_candidate_against_input,
    validate_compatibility_version, validate_conformance_contract_set, validate_denominator,
    validate_handoff, validate_no_action_against_input, validate_no_problem_against_input,
    validate_observation, validate_self_quality_input,
};
use serde_json::json;
