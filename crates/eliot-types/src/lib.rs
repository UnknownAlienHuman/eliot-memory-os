...
pub use memory::{
    ...
    IdempotencyOptions, InvariantCard, L0FeatureScore, L0RankTrace, L0SuppressionTrace,
    LeaseDecision, LeaseDenyReason, LeaseStatus, LifecycleStatus, LifecycleWriteOptions,
    LostAgentRecoveryRecord, MailboxMessage, MailboxMessageKind, MailboxMessageStatus,
    MailboxRecipient, MemoryConfidence, MemoryHandlePreview, MemoryWriteEnvelope,
