...
pub use memory::{
    ...
    PathRef, PluginInstallCheck, PluginManifestCheck, ProbeRecordCommand, ProjectRevisionSummary,
    ...
    ToolObservationInput, ToolObservationRecordCommand, TruncationInfo, UnderstandingProof,
