...
use eliot_learning_contracts::{
    AgentAttemptId, AssessmentDimension, CampaignActiveOverlayPolicy, CampaignHarnessOverlayCandidate,
    CampaignHistoryPlanReference, CampaignId, CampaignLearningStateProvenance,
    CampaignLearningStateView, CampaignOwnerRecordId, CampaignOwnerRevision, CampaignPositionKind,
    CampaignPositionRef, CampaignSourceRequirement, CampaignSourceResolution,
    CampaignSlotProjectionDigest, CampaignSourceBinding, CampaignSourceResolutionStatus,
    CampaignSourceRevisionRef,
    CampaignSourceRole, CausalCeiling, TASK_CONTROLLER_CAMPAIGN_OWNER_ID,
    ...
    SourceDenominator, StageDisposition, StageObservation, TargetId, ValueState, WorkScopeId,
};
