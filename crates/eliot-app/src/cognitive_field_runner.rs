...
use eliot_engine::{
    ...
    ProviderCallReservationOwner, validate_external_agent_execution_request,
};
use eliot_types::{
...
#[path = "provider_runtime_contract.rs"]
mod provider_runtime_contract;
use provider_runtime_contract::{
    ProviderRuntimeBinding, codex_cognitive_runtime_contract, enforce_provider_secret_boundary,
    preflight_codex_cognitive_runtime, provider_environment_surface, provider_runtime_contract,
};
...
mod tests {
    use super::{
        ...
        schema_validation_projection, seal_attempt_component, seal_manifest_hash, sha256_bytes,
    ...
    use eliot_engine::{
        CognitiveFieldGradingService, computed_provider_runtime_contract_sha256,
        seal_provider_runtime_contract,
    };
    use eliot_types::{
