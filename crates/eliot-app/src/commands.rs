...
use eliot_types::{
    ...
    CodeCortexRequest, CommandContext, CompletionStatus, ComponentHealth, ConfidenceLevel,
    ...
    SCHEMA_VERSION, SemanticCommand, ServiceHealthState, ServiceInstallAction,
