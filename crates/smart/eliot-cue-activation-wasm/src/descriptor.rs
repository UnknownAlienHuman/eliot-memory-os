//! Guest descriptor and pure-world import gate bound to `cue-activation.wit`.
//!
...
//! sources by hand-copying. The `cue-activation` world file is present and
...
/// WIT package identity from the readable `cue-activation.wit`.
pub const WORLD_PACKAGE: &str = "eliot:current@0.1.0";
/// WIT world name from the readable `cue-activation.wit`.
pub const WORLD_NAME: &str = "cue-activation";
/// WIT export name bound by this guest (`activate: func(...)`).
pub const EXPORT_NAME: &str = "activate";
...
pub const TYPED_WORLD_NAME: &str = "cue-activation";
...
pub const GUEST_WIT_BYTES: &[u8] =
    include_bytes!("../../../../bins/eliot-wasm-host/wit/typed/cue-activation.wit");
