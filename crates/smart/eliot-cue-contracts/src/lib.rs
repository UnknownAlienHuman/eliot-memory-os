...
pub use activation::{
    ...
    ActivationResult, ActivationResultSpec, ActivationStrength, ActivationTrace, BoundKind,
    Completeness, DerivedActivation, DirectActivation, RelationEdgeInput, TraceStep,
};
