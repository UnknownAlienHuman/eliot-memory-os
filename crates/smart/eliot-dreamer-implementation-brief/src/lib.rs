...
pub use model::{
    ...
    ImplementationDenominator, ImplementationEvidence, ImplementationGap, ImplementationGapClass,
    ImplementationMechanism, ImplementationObligation, ImplementationOmission,
