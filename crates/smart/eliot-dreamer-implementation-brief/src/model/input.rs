...
impl ImplementationMechanism {
    ...
    pub fn seal(&mut self) -> Result<(), ImplementationBriefError> {
        ...
        self.contract_refs = sorted_unique_strings(&self.contract_refs, "mechanism.contract_refs")?;
...
impl ImplementationDenominator {
    ...
    pub fn seal(&mut self) -> Result<(), ImplementationBriefError> {
        ...
        self.evidence_ids = sorted_unique_strings(&self.evidence_ids, "denominator.evidence_ids")?;
...
impl ImplementationBriefInput {
    ...
    pub fn validate(&self) -> Result<(), ImplementationBriefError> {
        ...
        ensure_canonical_ids(
            self.evidence.iter().map(|value| value.evidence_id.as_str()),
            "input.evidence",
        )?;
