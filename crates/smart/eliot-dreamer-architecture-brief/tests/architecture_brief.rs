...
use eliot_dreamer_contracts::{
    ...
    BundleMaterial, ClaimResidue, DreamInputBundle, DreamJobAdmission, GroundedDreamDraft,
    JobClass, ModelDraft, NormativePairBinding, OmissionHandle, PRESERVATION_DIMENSIONS,
