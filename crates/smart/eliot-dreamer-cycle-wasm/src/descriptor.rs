...
//! sources by hand-copying. The typed dreamer-cycle step world of #756 does
...
/// Dreamer-cycle subtype handled by this guest.
pub const HANDLER_SUBTYPE: &str = "dreamer-cycle";
...
pub const EXPECTED_TYPED_WORLD: &str = "dreamer-cycle-step";
