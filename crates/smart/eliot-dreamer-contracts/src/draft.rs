...
mod tests {
    ...
    fn valid_a05_receipt_binding_passes() {
        ...
        digest_preflight_probes(&item, &grounded);
    ...
    fn digest_preflight_probes(item: &ValidatedCurationItem, grounded: &GroundedDreamDraft) {
        let mut p1 = item.clone();
