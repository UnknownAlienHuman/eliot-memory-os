...
pub use user_automation_state::{
    AUTOMATION_CURSOR_ORDER_ASCENDING, AUTOMATION_CURSOR_VERSION, AUTOMATION_OPERATION_CREATE,
    AUTOMATION_OPERATION_EDIT, AUTOMATION_OPERATION_FAILURE, AUTOMATION_OPERATION_PAUSE,
    ...
    AUTOMATION_PAGE_INVOCATIONS, AUTOMATION_PAGE_NEXT_CURSOR, AUTOMATION_PAGE_REVISION,
    AUTOMATION_PAGE_REVISIONS, AUTOMATION_PAGE_STATE_FENCE, AUTOMATION_PARAM_AUTOMATION_ID,
    AUTOMATION_PARAM_CONFIGURATION_STATE, AUTOMATION_PARAM_CURSOR, AUTOMATION_PARAM_FAILURE_JSON,
    ...
    AutomationPageCursor, DecodedAutomationMutation, DecodedAutomationRead,
    MAX_AUTOMATION_CURSOR_BYTES, MAX_AUTOMATION_DOC_BYTES, MAX_AUTOMATION_ID_BYTES,
    MAX_AUTOMATION_PAGE_RECORDS, MAX_AUTOMATION_REVISION_ID_BYTES, USER_AUTOMATION_MUTATION_NAME,
    USER_AUTOMATION_READ_NAME, USER_AUTOMATION_SCOPE, USER_AUTOMATION_STATE_SCHEMA_V1,
    automation_create_params, automation_cursor_mint, automation_cursor_verify,
    automation_edit_params, automation_failure_history_ref, automation_failure_key,
    automation_failure_params, automation_invocation_read_request, automation_mutation_request,
