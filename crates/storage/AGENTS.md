...
BlobStore mechanics, export/backup and migration behavior. It does not own
semantic admission, task/finish meaning, authority epochs, process adoption, or
provider/model policy. Issue #19 is the integration owner; arbitrary JSON byte
preservation is #10.
