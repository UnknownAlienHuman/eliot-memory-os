...
pub use protocol::{
    ...
    KernelControlResponse, KernelReadyReceipt, RuntimeLeaseAdmission, RuntimeLeaseOwnerAdmission,
    RuntimeLeaseCensus, RuntimeLeaseCensusQuery, RuntimeLeaseOwnerKind, RuntimeLeaseReconcile,
    RuntimeLeaseRenewal, RuntimeLeaseTerminal,
    NATIVE_WORKER_CLAIM_WIRE_ID,
