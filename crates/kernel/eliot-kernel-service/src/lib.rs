...
pub use wasm_dispatch::{
    ...
    WasmGuestCeilings, WasmJoinGate, WasmJoinTable, WasmManifestRecord, WasmOwnerClaim, WasmPromotionRecord,
    WasmPublishedBundle, WasmSnapshotRecord, WasmWorkRecord, material_bytes,
