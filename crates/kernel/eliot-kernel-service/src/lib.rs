...
pub use protocol::{
    ...
    KernelControlResponse, KernelReadyReceipt, RuntimeLeaseAdmission, RuntimeLeaseReconcile,
    RuntimeLeaseRenewal, RuntimeLeaseTerminal, NATIVE_WORKER_CLAIM_WIRE_ID,
