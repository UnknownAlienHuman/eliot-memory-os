...
fn runtime_launch_descriptor_binds_exact_arguments_and_rejects_tampering() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            descriptor.doctor_artifact_digest.as_str(),
            "--testd-artifact-sha256",
            descriptor.testd_artifact_digest.as_str(),
            "--native-worker-artifact-sha256",
            descriptor.native_worker_artifact_digest.as_str(),
            "--eliotd-descriptor",
