...
pub struct HostLaunchOptions {
    pub(super) config_descriptor_path: PathBuf,
    pub(super) config_descriptor_digest: PlatformHandle,
    pub(super) installation: PlatformHandle,
    pub(super) transaction_plan_generation: u64,
    pub(super) host_state_root: PathBuf,
    pub(super) registration_nonce: Option<PlatformHandle>,
}
...
pub(super) fn valid_sha256_text(value: &str) -> bool {
    value.len() == 64
        && value
            .bytes()
