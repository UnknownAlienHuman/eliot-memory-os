...
impl LaunchLease {
    ...
    pub(super) fn read_bounded(&self, limit: u64) -> Result<Vec<u8>, String> {
        match self {
...
pub(super) fn approved_phase_b_destination_locator(
    supplied: &Path,
    approved: &PlatformHandle,
    profile: InstallationProfile,
...
pub(super) fn open_launch_lease(
    profile: InstallationProfile,
...
pub(super) fn verify_launch_digest(
    lease: &LaunchLease,
