use eliot_host_state::{
    ...
    LifecycleTimestamps, PriorKernelDisposition, PriorKernelSource, ReadinessApprovedContour,
    ReadinessEvidence, ReconcileOutcome,
};
#[cfg(windows)]
use eliot_host_state::{NonceState, StoreRebindRecord, StoreRebindState, record_checksum};
#[cfg(windows)]
...
#[cfg(windows)]
use eliot_runtime_contracts::{KernelActivationState, SupervisionLeasePredecessorIdentity};

#[cfg(windows)]
use super::{AuthenticatedKernelReadiness, PublishedSupervisionIdentity};
...
#[cfg(windows)]
pub(super) fn append_authenticated_kernel_readiness<B: JournalBackend>(
    journal: &HostStateJournalService<B>,
