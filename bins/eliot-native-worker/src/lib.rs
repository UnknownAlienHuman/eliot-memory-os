...
pub use kernel_admission_client::{
    KernelNativeWorkerClient, NATIVE_WORKER_CANCEL_OBSERVE_OPERATION,
    NATIVE_WORKER_CHECKPOINT_OPERATION, NATIVE_WORKER_CLAIM_OPERATION,
    NATIVE_WORKER_HEARTBEAT_OPERATION, NATIVE_WORKER_READY_OPERATION,
    NATIVE_WORKER_REGISTRATION_OPERATION, NATIVE_WORKER_RESULT_SUBMIT_OPERATION,
};
