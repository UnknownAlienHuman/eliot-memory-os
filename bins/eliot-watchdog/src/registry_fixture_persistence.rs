//! Test-only protected-registry fixture support for Watchdog tests.
//!
//! [`crate::FileWatchdogAdmission`] and [`crate::WatchdogAdmissionSource`] are
//! the source-backed production admission anchors; [`crate::HostObservation`]
//! remains observation evidence only. In the canonical failure-domain model
//! (A8.1, A13.2, A13.8; I8.1, I8.2, I2.16), this cell owns disposable redb
//! setup, fixture projections, and cleanup only.
//!
//! This fixture is never Watchdog admission, lifecycle, semantic, canonical,
//! SCM, spool, publication, self-admission, host-identity, external-kernel,
//! Surreal/store, or runtime-status authority.
