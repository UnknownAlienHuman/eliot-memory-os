...
use eliot_installation::{
    ...
    InstallerServiceRole, PendingActivationState, phase_b_scm_selector,
};
#[cfg(test)]
use eliot_platform_windows::{
    ProcessIdentity, ServiceBootstrapArguments, ServiceRegistrationRequest, WindowsAdapterError,
};
#[cfg(test)]
use eliot_runtime_contracts::{
    ProvisionedSupervisionAuthority, SignedSupervisionLease, SupervisionLeaseVerificationContext,
...
pub(crate) use service_registration_projection::{
    approved_service_registration, load_approved_service_registrations,
    service_approval_matches_manifest,
};
pub(crate) use service_registration_projection::{
