...
function Idempotency-Key([string]$writeId) {
    ...
    $material = @('phase-l10-l12-m6-v2',$projectId,$taskId,$flow,$writeId,$revision,($evidence -join ',')) -join '|'
...
function Source-Binding([string]$writeId) {
    ...
    $material = @('phase-l10-l12-m6-v2',$projectId,$taskId,$fields.case,$fields.flow,$fields.truth_revision) -join '|'
