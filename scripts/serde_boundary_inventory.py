...
FROZEN_FIXTURE_IDS = (
    FIXTURE_BRIDGE_ACCEPTANCE,
    FIXTURE_COMMENTS_STRINGS,
    FIXTURE_CUSTOM_REMOTE,
    FIXTURE_DERIVE_BASIC,
    FIXTURE_DERIVE_MULTILINE,
    FIXTURE_PROFILE_BRIDGE,
    FIXTURE_SHAPES,
    FIXTURE_TEST_SCOPE,
    FIXTURE_UNSUPPORTED,
    FIXTURE_VALUE_CONVERSION,
)
FROZEN_FIXTURE_SET = frozenset(FROZEN_FIXTURE_IDS)
ROW_EVIDENCE_REVISION = "929.1"
    ...
    payload = json.dumps(
        {
            ...
            "target": FIXED_TARGET,
            "row_evidence_revision": ROW_EVIDENCE_REVISION,
