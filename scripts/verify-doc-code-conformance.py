#!/usr/bin/env python3
"""Front door for documentation/source conformance.

The established checks remain in ``doc_code_conformance_core``. This module adds
pipeline-integrity checks for the documentation generator and router and extends
their deterministic negative fixtures.
"""
...
def audit(
    ...
    pipeline_findings, pipeline_metrics = documentation_pipeline_findings(
        root,
        cfg,
    )
...
def self_test() -> None:
    ...
    print("DOC_CODE_CONFORMANCE_PIPELINE_SELF_TEST: PASS cases=5")
